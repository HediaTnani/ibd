...
if __name__ == "__main__":
    ...
    p1 = Process(target=gimme_thread, args=(numpy.linspace(0,13,14,dtype=int).tolist(),))
    p2 = Process(target=gimme_thread, args=(numpy.linspace(14,27,14,dtype=int).tolist(),))
    p3 = Process(target=gimme_thread, args=(numpy.linspace(28,41,14,dtype=int).tolist(),))
    ...
    p11 = Process(target=gimme_thread, args=(numpy.linspace(140,153,14,dtype=int).tolist(),))
    p12 = Process(target=gimme_thread, args=(numpy.linspace(154,167,14,dtype=int).tolist(),))
    p13 = Process(target=gimme_thread, args=(numpy.linspace(168,181,14,dtype=int).tolist(),))
    p14 = Process(target=gimme_thread, args=(numpy.linspace(182,195,14,dtype=int).tolist(),))
    p15 = Process(target=gimme_thread, args=(numpy.linspace(196,209,14,dtype=int).tolist(),))
    p16 = Process(target=gimme_thread, args=(numpy.linspace(210,225,14,dtype=int).tolist(),))

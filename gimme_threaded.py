...
if __name__ == "__main__":
    ...
    p1 = Process(target=gimme_thread, args=(numpy.linspace(0,13,14).tolist()))
    p2 = Process(target=gimme_thread, args=(numpy.linspace(14,27,14).tolist()))
    p3 = Process(target=gimme_thread, args=(numpy.linspace(28,41,14).tolist()))
    p4 = Process(target=gimme_thread, args=(numpy.linspace(42,55,14).tolist()))
    p5 = Process(target=gimme_thread, args=(numpy.linspace(56,69,14).tolist()))
    p6 = Process(target=gimme_thread, args=(numpy.linspace(70,83,14).tolist()))
    p7 = Process(target=gimme_thread, args=(numpy.linspace(84,97,14).tolist()))
    p8 = Process(target=gimme_thread, args=(numpy.linspace(98,111,14).tolist()))
    p9 = Process(target=gimme_thread, args=(numpy.linspace(112,125,14).tolist()))
    p10 = Process(target=gimme_thread, args=(numpy.linspace(126,139,14).tolist()))
    p11 = Process(target=gimme_thread, args=(numpy.linspace(140,153,14).tolist()))
    p12 = Process(target=gimme_thread, args=(numpy.linspace(154,167,14).tolist()))
    p13 = Process(target=gimme_thread, args=(numpy.linspace(168,181,14).tolist()))
    p14 = Process(target=gimme_thread, args=(numpy.linspace(182,195,14).tolist()))
    p15 = Process(target=gimme_thread, args=(numpy.linspace(196,209,14).tolist()))
    p16 = Process(target=gimme_thread, args=(numpy.linspace(210,225,14).tolist()))

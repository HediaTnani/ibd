...
if __name__ == "__main__":
    ...
    p1 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(0,13,14,dtype=int).tolist(),))
    p2 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(14,27,14,dtype=int).tolist(),))
    p3 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(28,41,14,dtype=int).tolist(),))
    p4 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(42,55,14,dtype=int).tolist(),))
    p5 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(56,69,14,dtype=int).tolist(),))
    p6 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(70,83,14,dtype=int).tolist(),))
    p7 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(84,97,14,dtype=int).tolist(),))
    p8 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(98,111,14,dtype=int).tolist(),))
    p9 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(112,125,14,dtype=int).tolist(),))
    p10 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(126,139,14,dtype=int).tolist(),))
    p11 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(140,153,14,dtype=int).tolist(),))
    p12 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(154,167,14,dtype=int).tolist(),))
    p13 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(168,181,14,dtype=int).tolist(),))
    p14 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(182,195,14,dtype=int).tolist(),))
    p15 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(196,209,14,dtype=int).tolist(),))
    p16 = Process(target=gimme_thread, args=(model,transcript_df,exp_prof,numpy.linspace(210,225,14,dtype=int).tolist(),))
